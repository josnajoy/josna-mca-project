...
<!--form-stars-here-->
		<div class="book-form">
			   ...
			   <form method="post">
				...
				<input type="text" name="pickuparea" placeholder="" required=""><br></br>
			</div>
			<br></br>
					<div class="w3ls-field">
...
$sql="insert into route(busno,pickuparea,pickuptime,pickouttime,fee,curdate) values ('$busno','$pickuparea','$pickuptime','$pickouttime','$fee',NOW());";
//echo $sql;
