	...
	<div class="w3l-from">
		<form method="post">	
			...
			<div class="w3l-date">
					<label class="head">Birth Date<span class="w3l-star"> * </span></label>
						<div class="styled-input">
							<input class="date" id="datepicker" value="<?php echo $result['birthdate']?>"  name="birthdate" type="text" value="MM/DD/YYYY" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'MM/DD/YYYY';}" required="">
						</div>
			</div>	
			<?php
			...
			<div class="w3l-user">
					...
					<input type="text"  value="<?php echo $result['semester']?>" name="semester" placeholder="" required="">
				</div>
			<?php 
			...
			<div class="w3l-user">
					...
					<input type="text"  value="<?php echo $result['year']?>" name="year" placeholder="" required="">
				</div>
			<?php 
			...
			<div class="w3l-user">
				...
				<input type="password" value="<?php echo $result['password']?>" name="password" placeholder="" required="">
			</div>
			<?php 
...
$sql="update studreg set `fname`='$fname',`	`name`='$lname',	`id`='$id',	`gender`='$gender',	`dob`='$dob',  `address`='$address',  `phoneno`='$phoneno',  `branch`='$branch',	`semester`='$semester',	`year`='$year',	`route`='$route',	`stoppage`='$stoppage',	`email`='$email',	`password`='$password',	`confirmpassword`='$confirmpassword',	`curdate`=NOW() where uid=$uid;";
//echo $sql;
