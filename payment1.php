...
$j=1;
$payid=$inv+$j;
$query="INSERT INTO `payment`(`pid`, `rid`, `uid`, `amount`, `curdate`) VALUES ('$payid','$route`','$k','$amount',NOW());";
								...
								<div class="pay-tabs">
									<h2>Select Payment Method</h2>
									  <ul class="resp-tabs-list">
										  <li class="resp-tab-item" aria-controls="tab_item-0" role="tab"><span></li>
										   <div class="clear"></div>
									  </ul>	
								</div>
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
										<div class="payment-info">
											...
											<form Method="post" action="staffhome.html">
												...
												<?php
												 if(isset($validation['cardno'])) { 
														echo $validation['cardno'];
														}
													?>
												<div class="transaction">
													...
													<div class="tab-form-right user-form-rt">
														<h5>CVV NUMBER</h5>													
														<input type="text" name="cvvno" value="xxxx" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'xxxx';}" required="">
													</div>
													<?php
													 if(isset($validation['cvvno'])) { 
														echo $validation['cvvno'];
														}
													?>
										...
										<div class="tab-for">				
													<h5>AMOUNT</h5>
														<input type="text" name="amt" value="<?php echo $amount; ?>" readonly>
							 
										</div>
										
													<?php
													 if(isset($validation['amt'])) { 
														echo $validation['amt'];
														}
													?>
													<div class="clear"></div>
