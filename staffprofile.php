...
<body>
	...
	$uid=$_SESSION['uid'];
	$sql="select fname,lname,id,gender,branch,address,phoneno,joindate,route,stoppage,email,password,confirmpassword from staffreg where uid=$uid;";
	...
	<div class="w3l-from">
		<form  method="post">	
			<div class="w3l-user">
				...
				<input type="text" value="<?php echo $result['fname']?>" name="fname" disabled placeholder="" required="">
			</div>
			<div class="w3l-user">
				<label class="head">Last Name<span class="w3l-star"> * </span></label>
				<input type="text" value="<?php echo $result['lname']?>" name="lname" disabled placeholder="" required="">
			</div>
			<div class="w3l-user">
				<label class="head">Id<span class="w3l-star"> * </span></label>
				<input type="text" value="<?php echo $result['id']?>" name="id" disabled placeholder="" required="">
			</div>
			...
			<div class="w3l-right" name="address">
					...
					<textarea  disabled name="add" disabled ><?php echo $result['address']?></textarea>
				</div>	
...
$URL="http://localhost/collegetransportation/editstaffprofile1.php";
